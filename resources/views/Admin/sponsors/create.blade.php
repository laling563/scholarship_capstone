                ...
                <fieldset class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="sponsor_name" name="sponsor_name" value="{{ old('sponsor_name') }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="type" class="form-label">Scholarship Type</label>
                            <select class="form-select" id="type" name="type" required>
                                <option value="" disabled selected>Select a type</option>
                                <option value="sport" {{ old('type') == 'sport' ? 'selected' : '' }}>Sports Scholarship</option>
                                <option value="financial_aid" {{ old('type') == 'financial_aid' ? 'selected' : '' }}>Financial Aid</option>
                            </select>
                        </div>
                    </div>
                     <div class="row">
