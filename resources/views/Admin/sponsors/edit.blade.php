...
<style>
    ...
    .form-control[value]:not([value=""]) {
        background: linear-gradient(135deg, rgba(67, 97, 238, 0.02) 0%, rgba(255, 255, 255, 0.95) 100%) !important;
    }
...
<div class="container-fluid">
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">✏️ Edit Sponsor: {{ $sponsor->sponsor_name }}</h5>
            ...
            <form action="{{ route('admin.sponsors.update', $sponsor) }}" method="POST">
                ...
                <fieldset class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror"
                                ...
                                <option value="" disabled>Select a scholarship type</option>
                                <option value="sport" {{ old('type', $sponsor->type) == 'sport' ? 'selected' : '' }}>
                                    ⚽ Sports Scholarship
                                </option>
                                <option value="financial_aid" {{ old('type', $sponsor->type) == 'financial_aid' ? 'selected' : '' }}>
                                    💰 Financial Aid
                                </option>
                            </select>
                            @error('type')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('contact_number') is-invalid @enderror"
                                   ...
                                   value="{{ old('contact_number', $sponsor->contact_number) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('notes') is-invalid @enderror"
                                  ...
                                  placeholder="Enter any additional information about the sponsor...">{{ old('notes', $sponsor->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('username') is-invalid @enderror"
                                   ...
                                   value="{{ old('username', $sponsor->username) }}"
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-3">
                        <a href="{{ route('admin.sponsors.show', $sponsor) }}" class="btn btn-outline-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Show password strength indicator for password field
    const passwordInput = document.getElementById('password');
    if (passwordInput) {
        passwordInput.addEventListener('input', function() {
            const parent = this.parentElement;
            const strengthText = parent.querySelector('.password-strength') ||
                                (() => {
            ...
            strengthText.innerHTML = getStrengthMessage(strength);
            strengthText.className = `password-strength mt-2 text-sm ${getStrengthClass(strength)}`;
        });
        ...
        function getStrengthMessage(strength) {
            ...
            return `Password Strength: ${messages[strength]}`;
        }
