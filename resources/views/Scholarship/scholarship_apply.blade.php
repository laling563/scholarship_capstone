...
@section('content')
    ...
    <style>
        ...
        .main-content { max-width: calc(100% - 250px); margin-left: auto; }
        .icon-circle { width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.9rem; }
        .info-item { background-color: #f8f9fa; border-radius: 6px; }
        .card { border-radius: 10px; }
        .card-header { padding: 0.75rem 1.25rem; }
        .form-control, .form-select, .input-group-text { font-size: 0.875rem; }
        @media (max-width: 768px) {
            .main-content { max-width: 100%; margin-left: 0; padding-left: 15px; padding-right: 15px; }
